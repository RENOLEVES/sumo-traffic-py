...
python "%SUMO_HOME%tools\randomTrips.py" -n montreal.net.xml --seed 42 --fringe-factor 2 -p 1.5 -e 600 -o Trips/montreal.motorcycle.trips.xml --vehicle-class motorcycle --vclass motorcycle --prefix moto --fringe-start-attributes "departSpeed=\"max\"" --max-distance 1200 --trip-attributes "departLane=\"best\"" --validate
