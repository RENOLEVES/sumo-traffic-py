...
python %SUMO_HOME%/tools/edgesindistricts.py -n %netFile% -t %tazFile% -o "taz_edges.taz.xml"

python updateMatrixConf.py -c "OD_matrix.conf.xml" --od-matrix-dir %odDir% -t "taz_edges.taz.xml"
echo.
...
%SUMO_HOME%/bin/od2trips -c "OD_matrix.conf.xml" -o %tripPath%.passenger.odtrips.xml --scale 3 --vtype "veh_passenger" --prefix "veh"
python addClassToTrips.py -od %tripPath%.passenger.odtrips.xml -i "veh_passenger" -v "passenger"
python validateTrips.py -n %netFile% -t %tripPath%.passenger.odtrips.xml -v "passenger"
echo.

echo Creating trips for motorcyles ...
%SUMO_HOME%/bin/od2trips -c "OD_matrix.conf.xml" -o %tripPath%.motorcycle.odtrips.xml --scale 1.5 --vtype "moto_motorcycle" --prefix "moto"
python addClassToTrips.py -od %tripPath%.motorcycle.odtrips.xml -i "moto_motorcycle" -v "motorcycle"
python validateTrips.py -n %netFile% -t %tripPath%.motorcycle.odtrips.xml -v "motorcycle"
echo.

echo Creating trips for buses ...
%SUMO_HOME%/bin/od2trips -c "OD_matrix.conf.xml" -o %tripPath%.bus.odtrips.xml --scale 1 --vtype "bus_bus" --prefix "bus"
python addClassToTrips.py -od %tripPath%.bus.odtrips.xml -i "bus_bus" -v "bus"
python validateTrips.py -n %netFile% -t %tripPath%.bus.odtrips.xml -v "bus"
echo.

echo Creating trips for trucks ...
%SUMO_HOME%/bin/od2trips -c "OD_matrix.conf.xml" -o %tripPath%.truck.odtrips.xml --scale 0.5 --vtype "truck_truck" --prefix "truck"
python addClassToTrips.py -od %tripPath%.truck.odtrips.xml -i "truck_truck" -v "truck"
python validateTrips.py -n %netFile% -t %tripPath%.truck.odtrips.xml -v "truck"
echo.
...
python ../StopSigns/addStops.py -n %netFile% -r %routePath%.passenger.rou.xml -v "passenger"
python ../StopSigns/addStops.py -n %netFile% -r %routePath%.motorcycle.rou.xml -v "motorcycle"
python ../StopSigns/addStops.py -n %netFile% -r %routePath%.bus.rou.xml -v "bus"
python ../StopSigns/addStops.py -n %netFile% -r %routePath%.truck.rou.xml -v "truck"
echo.
echo Done
pause